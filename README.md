...
# Overview
- **Name**:STM32C552_SENSOR-V2.0
- **MCU**: STM32C552CET6/STM32C552CEU6
...
<img width="1238" height="1760" alt="image" src="https://github.com/user-attachments/assets/c5ac6bd3-964a-4510-b7bb-07990fcdf765" />

<img width="1238" height="1760" alt="image" src="https://github.com/user-attachments/assets/e3cc5275-3f63-4b68-9b3c-23243a405b7a" />

<img width="1240" height="1760" alt="image" src="https://github.com/user-attachments/assets/cd86b7e7-1522-4879-bb53-093bbedb8634" />

<img width="1239" height="1760" alt="image" src="https://github.com/user-attachments/assets/81664720-70a4-44ea-896a-f9c047a914bd" />

<img width="1243" height="1758" alt="image" src="https://github.com/user-attachments/assets/03c80310-598a-4815-9ba6-dfdfd4e76477" />
...
- **STM32C552_Project1**:STM32C552开发(1)----点亮LED
- **CSDN Blog**:[https://blog.csdn.net/qq_24312945/article/details/161573406](https://blog.csdn.net/qq_24312945/article/details/161573406)
  
STM32C552 & SENSOR是一款基于STM32C5系列微控制器的评估套件。该微控制器采用了40nm工艺制造，具有更快的FLASH访问，更高的性能以及更低的功耗。此外，该套件具有丰富的接口和外设，以及传感器（SENSOR）系列连接器接口，为开发者提供了便捷且灵活的开发环境。
这里通过配置LED输出进行简单测试。
STM32C552 & SENSOR is an evaluation kit based on the STM32C5 series microcontroller. The microcontroller is manufactured using a 40 nm process, offering faster Flash access, higher performance, and lower power consumption. In addition, the kit provides rich interfaces and peripherals, as well as SENSOR series connector interfaces, offering developers a convenient and flexible development environment.

In this example, a simple test is performed by configuring the LED output.



- **STM32C552_Project2**:STM32C552开发(2)----BOOT_SEL设置
- **CSDN Blog**:[https://blog.csdn.net/qq_24312945/article/details/161573534](https://blog.csdn.net/qq_24312945/article/details/161573534)
...
- **STM32C552_Project3**:STM32C552开发(3)----配置串口打印
- **CSDN Blog**:[https://blog.csdn.net/qq_24312945/article/details/161614079](https://blog.csdn.net/qq_24312945/article/details/161614079)
